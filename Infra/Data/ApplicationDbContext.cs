...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Lanche>().HasData(
            ...
            new Lanche { LancheId = 4, Nome = "anche Natural Peito Peru", DescricaoCurta = "Pão Integral, queijo branco, peito de peru, cenoura, alface, iogurte", DescricaoLonga = "Pão integral natural com queijo branco, peito de peru e cenoura ralada com alface picado e iorgurte natural", Preco = 15.0M, ImagemUrl = "~/imagens/produtos/lanchenatural.jpg", LanchePreferido = true,  EmEstoque = true, CategoriaId = 2, CreatedBy = "teste", CreatedOn = DateTime.Now, EditedBy = "teste", EditedOn = DateTime.Now}
        );
    }
}
